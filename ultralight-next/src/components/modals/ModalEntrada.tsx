  ...
  return (
    <div className="modal-backdrop" onClick={e => e.target === e.currentTarget && onClose()}>
      <div className="modal-box animate-slide-up">
        {/* Header */}
        <div className="flex items-center justify-between px-6 py-5 bg-green-50 border-b border-green-200 rounded-t-2xl">
          <div className="flex items-center gap-3.5">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mt-0.5">Adicionar itens ao estoque</p>
            </div>
          </div>
        ...
        <div className="px-6 py-5 space-y-4">
          ...
          {produto && (
            <div className="flex gap-5 bg-gray-50 border border-gray-200 rounded-lg px-4 py-2.5 text-sm text-gray-600">
              <span>Saldo atual: <strong className="text-gray-900">{produto.saldo} {produto.unidade}</strong></span>
        ...
        <div className="px-6 py-4 border-t border-gray-100 flex justify-end gap-2.5">
          ...
          <button onClick={handleConfirm} className="inline-flex items-center gap-2 px-5 py-2 bg-green-600 hover:bg-green-700 text-white text-sm font-semibold rounded-lg transition-colors">
