  ...
  return (
    <div className="fixed bottom-6 right-6 z-[200] flex flex-col gap-2.5 pointer-events-none">
      {toasts.map(t => (
        <div
          key={t.id}
          className={`flex items-center gap-3 px-4 py-3.5 bg-white rounded-xl shadow-xl border-l-4 ${borders[t.type]} min-w-[280px] max-w-[360px] pointer-events-auto animate-slide-in`}
        >
          {icons[t.type]}
